...
public class CampaignStatisticsRecord extends UpdatableRecordImpl<CampaignStatisticsRecord> implements Record6<Integer, String, String, Instant, Integer, Integer> {
    ...
    @Override
    public Row6<Integer, String, String, Instant, Integer, Integer> valuesRow() {
    ...
    @Override
    public CampaignStatisticsRecord value4(Instant value) {
        setDate(value);
        return this;
    }
    ...
    @Override
    public CampaignStatisticsRecord values(Integer value1, String value2, String value3, Instant value4, Integer value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CampaignStatisticsRecord(Integer id, String datasource, String campaignName, Instant date, Integer clicks, Integer impressions) {
        super(CampaignStatistics.CAMPAIGN_STATISTICS);
